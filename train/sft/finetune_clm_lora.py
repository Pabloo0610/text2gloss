...
class MyCallback(TrainerCallback):
    ...
    def on_step_begin(self, args, state, control, **kwargs):
        ...
        print("Embedding checking")
        #print("******************************")
        
        device = torch.device('cuda')
        embeddings = kwargs["model"].get_input_embeddings()
        #print(embeddings)
        ...
        #print(tensors)
        # sd = kwargs["model"].state_dict()
        # print(sd)
        #test auto upload

# class PeftModel_with_Embedding(PeftModel):
    ...
    def on_save(
        ...
        **kwargs,
        ...
        if state.is_world_process_zero:
            ...
            # #we want to save embeddings too
            # saved_path = os.path.join(checkpoint_folder, 'embedding_weight.bin')
            # embedding_name = 'model.embed_tokens.weight'
            # embedding_name_in_finetune_model = 'base_model.model.model.embed_tokens.weight'
            # sd = kwargs["model"].state_dict()
            # #print(sd)
            # embedding_dict = {embedding_name_in_finetune_model: sd[embedding_name_in_finetune_model]}
            # torch.save(embedding_dict, saved_path)
            # print(sd)
...
def main():
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        #print("tokenized input:", tokenized_full_prompt)
...
#        print(new_embeddings(torch.LongTensor([64999])))
#        print(new_embeddings(torch.LongTensor([66666])))
